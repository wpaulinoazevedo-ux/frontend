...
Para acessar a página, acesse o diretório frontend e abra o arquivo index.html.
...
## Veículos
Para cadastrar um veículo são necessárias as informações: Nome do cliente, CPF do cliente, Telefone, Placa, Modelo, Ano e Cor do carro.
